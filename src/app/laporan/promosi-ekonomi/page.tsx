...
export const metadata: Metadata = {
  title: "Promosi Ekonomi Anggota - KSP",
};

export default async function PromosiEkonomiPage() {
  ...
  return (
    <div className="min-h-screen">
      <main className="max-w-7xl mx-auto px-6 py-6">
        <h1 className="text-2xl font-bold text-gray-900 mb-1">Laporan Promosi Ekonomi Anggota</h1>
